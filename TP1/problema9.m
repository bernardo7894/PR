...
subplot(2,2,1), yyaxis left, plot(f, modulo_ii_A_CC, 'LineWidth', 2), ...
...
subplot(2,2,2), yyaxis left, plot(f, modulo_ii_A_CA, 'LineWidth', 2), ...
    ylabel('Módulo'), xlabel('Frequência [Hz]'), grid on, hold on, yticks(1), ...
    yyaxis right,  plot(f, fase_ii_A_CA*(180/pi), 'LineWidth', 2), ...
    ylabel('Fase [º]'), legend("Módulo", "Fase"), xlim([min(f) max(f)]), ...
    ylim([-180 180]), yticks(-180:45:180), ...
    title("\rho_L em função da frequência, CA e sem perdas");
subplot(2,2,3), yyaxis left, plot(f, modulo_ii_B_CC, 'LineWidth', 2), ...
...
subplot(2,2,4), yyaxis left, plot(f, modulo_ii_B_CA, 'LineWidth', 2), ...
    ylabel('Módulo'), xlabel('Frequência [Hz]'), grid on, hold on, ...
